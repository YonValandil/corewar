...
/*   Updated: 2018/06/18 05:10:39 by jjourne          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// #include "op.h"
#include "corewar.h"//j'ajoute mon file corewar.h??

t_optab	g_op_tab[17] = //modif avec les ptr sur fonction (c'est ok?)
{
	...
	{"lldi", &lldi, 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 14, 50,
		"long load index", 1, 1},
	{"lfork", &op_lfork, 1, {T_DIR}, 15, 1000, "long fork", 0, 1},
